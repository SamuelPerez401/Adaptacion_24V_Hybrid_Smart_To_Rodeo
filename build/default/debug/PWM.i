...
void PWM(){
    ...
    PWM_POT_Result = (PWM_POT_Value * (1670 / 4095.0));
    PWM_POT_Result = (PWM_POT_Result + 910);

    PWM_POT_AP_Value = ADCC_GetSingleConversion(POT_PWM_AP);
    PWM_POT_AP_Result = (PWM_POT_AP_Value * (520 / 4095.0));
    PWM_POT_AP_Result = (PWM_POT_AP_Result + 260);
    ...
    if(PWM1S1P1 > 0 && PWM1S1P2 == 0 && !fade_out_ap){
    ...
    }else if(PWM1S1P2 > 0 && PWM1S1P1 == 0 && !fade_out_cl){
    ...
    }else if(PWM1S1P2 > 0 && fade_out_cl){
